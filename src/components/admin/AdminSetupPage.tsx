...
export default function AdminSetupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await setupFirstAdmin(adminData);
            router.push('/admin/dashboard'); // Redirect to admin dashboard after successful setup
        } catch (error) {
    ...
    return (
        <div className="md:w-full max-w-md w-5/6 mx-auto">
            <div className="bg-white rounded-lg shadow-md p-6">
                <h1 className={`text-2xl font-bold text-center mb-1 ${colorClasses.primary.text}`}>
                    Setup Admin Account
                </h1>
                <p className={`text-l text-center mb-2 ${colorClasses.primary.text}`}>
                    Create the first administrator account for Zeynix
                </p>
