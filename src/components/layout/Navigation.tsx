...
import { Menu, X, User, ShoppingCart, Heart, Package } from 'lucide-react';
...
export default function MobileNavigation({ isOpen, onClose }: MobileNavigationProps) {
    return (
        <>
            ...
            {/* Mobile Menu */}
            <div className={`fixed top-0 right-0 h-full w-80 bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'
                }`}>
                <div className="p-6">
                    {/* Close Button */}
